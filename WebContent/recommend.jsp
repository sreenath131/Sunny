...
<section>
	<form class="form-horizontal" action="StudyController?action=recommend"
		method="post">
...
<p class="text-center">When your friend logs in and participates in
	one user study, you'll get 2 coins bonus</p>
<br>
<br>
<br>
<br>

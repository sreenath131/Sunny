...
<section>
	<form class="form-horizontal" action="StudyController?action=add"
		method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" name="participant_text"
					id="participant_text" maxlength="2" required />
			</div>
		</div>
		...
		<div id="TextBoxContainer"><!-- Textboxes will be added here -->
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<textarea name="textbox" class="form-control" required></textarea>
			</div>
		</div>

...
{
  static ArrayList<Report> reportList = new ArrayList();
  ...
  public static void addReport(Report rep)
  {
    ...
    String query = "INSERT INTO reported (QuestionID, StudyID, Date, Question, Username, NumParticipants, Status) VALUES (?, ?, ?, ?, ?, ?, ?)";
    try
    {
      ps = connection.prepareStatement(query);
  ...
  public static Report getReport(String scode, String email)
  {
    ConnectionPool pool = ConnectionPool.getInstance();
    Connection connection = pool.getConnection();
    PreparedStatement ps = null;
  ...
  public static void updateReportStatus(String sCode, String email, String status)
  {
    ...
    Connection connection = pool.getConnection();
    PreparedStatement ps = null;
    String query = "UPDATE reported SET Status = ? WHERE StudyID = ? and username=?";
    try
    {
      ps = connection.prepareStatement(query);
